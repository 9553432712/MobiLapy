				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-6 col-md-6 ">
							<h6 class="text-white ">Need a repair? just call</h6>
							<h1 class="text-uppercase">
								MobiLappy
							</h1>
							<p class="pt-10 pb-10 text-white">
								Whether you are busy working or enjoying your day, don't spend a minute to think about your gadget(mobile/laptop/tablet) repair.
							</p>
							<a href="#" class="primary-btn text-uppercase">Call:9666419044</a>
						</div>
						<div class="col-lg-4  col-md-6 header-right">
							<h4 class="pb-30">Mobile / Laptop / Tablet!</h4>
							<form class="form" action="<%=request.getContextPath()%>/insert" method="post">
								...
								<div class="from-group">
							    	<input class="form-control txt-field" type="text" name="Brand_model" placeholder="Brand and model"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Brand and model'">
							    	<input class="form-control txt-field" type="text" name="Issue" placeholder="Issue"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'">
							    </div>
							    <div class="form-group">
									<div class="input-group dates-wrap">
										<input id="datepicker2" class="dates form-control"  placeholder="Best time for device pickup" type="text">
							    ...
							    <div class="form-group">
							            ...
							            <button class="btn btn-default btn-lg btn-block text-center text-uppercase">Confirm repair request</button>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 about-left">
							<img class="img-fluid" src="img/mobilappy.jpg" alt="">
						</div>
						<div class="col-lg-6 about-right">
							<h1>The process we follow</h1>
							<h4>Transparency in price & standardization of process</h4>
							<p>1) You will receive a text with a secret code for our delivery person who would pick the device from you at the mentioned slot.
                             <br></br>  2)The person would take a few photographs of the device and share it with you for reference.
                              <br></br> 3)Our technician will diagnose the	device and give you a quotation. We will start repair only after your approval.
                             <br></br>  4)We offer the best price in the city. Without repair our cost is only 60 INR for logistics purpose.
							</p>
